...
// Handle Browser Test (GET Request) - To confirm file exists
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    echo "<h1>Chatbot Status: ACTIVE</h1>";
    echo "If you see this, the file is working perfectly on the server.<br>";
    if (file_exists('../includes/db_connect.php')) {
        include '../includes/db_connect.php';
        if (isset($conn) && !$conn->connect_error) {
            echo "<strong style='color:green'>Database: Connected</strong><br>";
        } else {
            echo "<strong style='color:red'>Database: Failed</strong><br>";
        }
    } else {
        echo "<strong style='color:red'>DB File Missing</strong><br>";
    }
    exit;
}
